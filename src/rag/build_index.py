...
# ---------------------------------------------------------------------
# Project paths (repo-root based; no dependency on cwd)
# build_index.py is at: <root>/src/rag/build_index.py
...
META_PATH = INDEX_DIR / "chunks_meta.pkl"  # keep consistent with retriever.py
...
# Embedding model (must match retriever side)
